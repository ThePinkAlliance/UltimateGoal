...
@Config
public class PinkNavigateTest extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(1, 0.1, 1);
    ...
    public static WheelTracker tracker;
    ...
    public PinkNavigateTest(HardwareMap hardwareMap) {
