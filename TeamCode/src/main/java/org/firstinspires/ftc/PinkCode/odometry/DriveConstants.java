...
public class DriveConstants {
     ...
     */
    public static final double TICKS_PER_REV = 8192; //537.6 prev
     ...
     */
    public static double WHEEL_RADIUS = 2; // 4 prev in
    public static double GEAR_RATIO = .825; // output (wheel) speed / input (motor) speed
